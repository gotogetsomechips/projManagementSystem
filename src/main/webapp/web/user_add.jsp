  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $("#realName").on("blur", function() {
        ...
        if (!realName) {
          $message.text("真实姓名不能为空").removeClass("success").addClass("error");
        } else {
      ...
      $("#phone").on("blur", function() {
        ...
        if (!phone) {
          $message.text("联系电话不能为空").removeClass("success").addClass("error");
      ...
      $("#email").on("blur", function() {
        ...
        if (!email) {
          $message.text("电子邮箱不能为空").removeClass("success").addClass("error");
...
<div class="container">
  <div class="form-title">添加新用户</div>

  <form action="${pageContext.request.contextPath}/user/add?sortField=${param.sortField}&sortDirection=${param.sortDirection}" method="post">
    ...
    <div class="button-group">
      ...
      <a href="${pageContext.request.contextPath}/user/list" class="button button-cancel">取消</a>
    </div>
  </form>
</div>
</body>
